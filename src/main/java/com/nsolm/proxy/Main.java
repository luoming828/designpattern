package com.nsolm.proxy;

import com.nsolm.proxy.pool.LazyDataSource;
import com.nsolm.proxy.pool.PooledDataSource;
...
public class Main {
	...
	static final String jdbcUrl = "jdbc:mysql://localhost/learnjdbc?useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai";
